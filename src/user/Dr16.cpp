...
Dr16::Dr16() : m_LHAxis(0.0f),
               ...
               m_PrevMouseRState(0),
               m_LastUpdateTick(0),
               m_LastDr16UpdateTick(0),
               m_LastJSUpdateTick(0),
               m_TimeoutTick(100)
{
}
...
void Dr16::ReceiveUpdate()
{
    if (bsp_get_rx_flag())
    {
        m_LastDr16UpdateTick = Time::GetTick();
...
int16_t Dr16::GetMouseX()
{
    return pRcRaw->mouse.x;
}

int16_t Dr16::GetMouseY()
{
    return pRcRaw->mouse.y;
}

int16_t Dr16::GetMouseZ()
{
    return pRcRaw->mouse.z;
}

bool Dr16::IsTimeout()
{
    return this->Dr16Timeout() ;
}

bool Dr16::Dr16Timeout()
{
    return (Time::GetTick() > m_TimeoutTick + m_LastDr16UpdateTick);
}
